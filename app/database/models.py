...
class Pet(Base):
    ...
    images = Column(LargeBinary)  # New field to store pet images, can be a list or single image
...
class Post(Base):
    ...
    post_type = Column(String)  # New field to specify the type of post
    title = Column(String)
    abstract = Column(String)
    content = Column(String)
    cover_image = Column(LargeBinary)  # New field for the cover image
